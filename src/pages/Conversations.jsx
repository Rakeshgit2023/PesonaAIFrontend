...
const Conversations = () => {
  ...
  return (
    <>
      ...
      <div className="h-[calc(100vh-64px)] md:h-[calc(100vh-80px)] flex flex-col gap-3 px-16">
                      ...
                      className={`rounded-lg shadow-sm px-2.5 lg:text-xs xl:text-sm break-words font-medium
                        ${
                          isOwnMessage
                            ...
                            : "pt-3.5 bg-[#EFF8FF] border border-slate-200 text-slate-500"
                        }
          ...
          {loadingContent && (
            ...
            >
              ...
              <div className="px-4 py-1.5 rounded-md shadow-md">
                <SyncLoader loading={loadingContent} size={5} color="#6b46c1" />
              </div>
            </div>
          )}
        ...
        <div className="h-[10%] mb-2 flex gap-2 px-8">
          ...
          >
            {loadingContent ? (
              <ClipLoader loading={loadingContent} size={30} color="white" />
            ) : (
              <RiSendPlaneFill />
            )}
          </div>
